                                        ...
                                        <div class="ads">
                                                <div class="item">
                                                        <div class="main">
                                                                ...
                                                                $top = AdPayment::model()->findByAttributes(array('position' => '1', 'admin_approve' => '1', 'status' => 1), $criteria);
                ...
                <div class="row">
                        <div class="col-md-4">
                                <div class="ads-banner">
                                        ...
                                        $criteria->addCondition('display_from <= "' . date('Y-m-d') . '" ');
                                        $criteria->addCondition('display_to >= "' . date('Y-m-d') . '" ');
                                        $top_left = AdPayment::model()->findAllByAttributes(array('position' => 2, 'admin_approve' => 1, 'status' => 1), $criteria, array('order' => 'id DESC', 'limit' => 2));
                                        ...
                                        if (!empty($top_left)) {
                                                ...
                                                <div class="item">
                                                        <div class="main">
                                                                <img src="<?= Yii::app()->baseUrl . '/images/default-left-offer.jpg' ?>">
                                                        </div>
                                                </div>
                                        <?php } ?>
                                </div>
                        ...
                        <div class="col-md-8">
                                <div id="fw_al_004" class="carousel ps_zoom_i ps_control_bround swipe_x ps_easeInOut" data-ride="carousel" data-pause="hover" data-interval="5000" data-duration="2000">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                                ...
                                                $criteria->addCondition('display_from <= "' . date('Y-m-d') . '" ');
                                                $criteria->addCondition('display_to >= "' . date('Y-m-d') . '" ');
                                                $top_left = AdPayment::model()->findAllByAttributes(array('position' => 3, 'admin_approve' => 1, 'status' => 1), $criteria, array('order' => 'id DESC', 'limit' => 2));
                                                //                    $top_left = AdPayment::model()->findAllByAttributes(array('position' => 2, 'vendor_name' => Yii::app()->session['merchant']['id'], 'status' => 1), array('order' => 'id DESC', 'limit' => 2));
                                                if (!empty($top_left)) {
                                                        $i = 1;
                                                        foreach ($top_left as $tp_left) {
