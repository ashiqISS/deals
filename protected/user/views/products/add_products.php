                        ...
                        <div class="col-lg-9 col-md-8">
                                ...
                                <div class="accountsettings">
                                        ...
                                        <div class="ui-set">
                                                <div class="settings1">
                                                        <div class="form-group">
                                                                <label class="set"><?php echo $form->labelEx($model, 'Main Image ( image size : 250 X 141 )'); ?></label>
                                                        </div>
                                                </div>
                                                <div class="settings2">
                                                        <span>:</span>
...
<?php } ?>
                                                                ...
                                                                <!--<div class="col-sm-10">-->
                                                                <?php echo $form->fileField($model, 'main_image', array('size' => 60, 'maxlength' => 100, 'class' => 'form-set')); ?>
                                                                <?php
                                                ...
                                                <div class="ui-set">
                                                        <div class="settings1">
                                                                <div class="form-group">
                                                                        <label class="set"> <?php echo $form->labelEx($model, 'deal_location'); ?></label>
                                                                </div>
                                                        </div>
                                                        <div class="settings2">
                                                                <span>:</span>
                                                        ...
                                                        <div class="settings3">
                                                                <div class="form-group">
                                                                        ...
                                                                        <div>
                                                                                <?php
                                                                                $this->widget('application.user.components.Location', array(
                                                                                    'type' => 'location',
