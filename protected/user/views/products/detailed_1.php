                ...
                <div class="soon">
                    ...
                    <?php if (Yii::app()->session['user']['id'] != '') { ?>
                            <ul>
                                ...
                                <li><a href="https://twitter.com/intent/tweet?url=URLTOBESHARED">Share on Twitter</a></li>
                                <li><a class="twitter-share-button"
                                       href="https://twitter.com/intent/tweet?text=Hello%20world"
                                       data-size="large">
                                        Tweet</a></li>
                                <li><a id="shareBtn1"><i class="fa dev fa-twitter"></i></a></li>
                                <li><a id="shareBtn1"><i class="fa dev fa-google-plus"></i></a></li>
...
//              action_type: 'og.likes',
                href: 'http://intersmarthosting.in/dealsonindia/index.php/products?name=<?php echo $products->canonical_name ?>',
