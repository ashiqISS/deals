                        ...
                        <div class="col-xs-12">
                                ...
                                <div class="contact-form contact-forms">
                                        ...
                                        <?php } else { ?>
                                                ...
                                                <?php endif; ?>
                                                <form role="form" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/ForgotPassword/Vendor" method="post">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-6 padd">
                                                                <?php echo CHtml::link('Sign Up Free', array('Site/VendorRegister'), array('class' => 'forgot')); ?>
