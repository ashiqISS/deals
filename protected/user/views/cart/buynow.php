                        ...
                        <div class="col-xs-12">
                                ...
                                <?php if (Yii::app()->user->hasFlash('successcoupon')) { ?>
                                        <div class="alert alert-success">
                                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                <strong>Success!</strong> <?php echo Yii::app()->user->getFlash('successcoupon'); ?>
                                        </div>
                                        ...
                                        <div class="purchase">
                                                ...
                                                <div class="pur-2">
                                                        ...
                                                        <div class="part3">
                                                                <ul>
                                                                        <li>Unit Price</li>
                                                                        <li><?php echo Yii::app()->Discount->DiscountCartUnit($product, $cart->quantity); ?></li>
                                                                </ul>
                                                        </div>
                                                </div>
                                                <div class="pur-3">
                                ...
                                <table id="t03">
                                        <tbody>
                                                <tr>
                                                        ...
                                                        <td><span class="colors1"><?php echo Yii::app()->Currency->convert(Yii::app()->Discount->Subtotal()); ?></span></td>
                                                </tr>
                                                <?php
                                                $sumarray = array();
                                                $billcat = array();
...
//                                                print_r($sumarray);
                                                ...
                                                <tr>
                                                        <td>Total</td>
                                                        <td><span class="colors"><?php echo Yii::app()->Currency->convert(Yii::app()->Discount->Granttotal()); ?></span></td>
                                                </tr>
                                        </tbody>
                                </table>
                                <div class="clearfix"></div>
                                ...
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/cart/proceed"><button type="submit" class="btn new-btn1 btn-default"> Proceed to Checkout</button></a>
                                                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/index"><button type="submit" class="btn new-btn2 btn-default"> Continue Shopping</button></a>
