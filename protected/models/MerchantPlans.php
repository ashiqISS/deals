...
class MerchantPlans extends CActiveRecord {
        ...
        public function rules() {
                ...
                return array(
                    ...
                    array('id, plan_id, user_id, plan_name, amount, date_of_creation, no_of_product, no_of_product_left, no_of_ads, no_of_ads_left, no_of_days, no_of_days_left, status, cb, doc, ub, dou', 'safe', 'on' => 'search'),
                );
        }
