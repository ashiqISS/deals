...
// $this->performAjaxValidation($model);
                ...
                if (isset($_POST['BuyerDetails'])) {
                        ...
                        $model->user_status = $_POST['BuyerDetails']['user_status'];
...
// $this->performAjaxValidation($model);
                ...
                if (isset($_POST['BuyerDetails'])) {
                        ...
                        $model->first_name = $_POST['BuyerDetails']['first_name'];
                        $model->last_name = $_POST['BuyerDetails']['last_name'];
                        $model->email = $_POST['BuyerDetails']['email'];
