...
<div class="form">
        ...
        <div class="form-group">
                <?php echo $form->labelEx($model, 'user_status', array('class' => 'col-sm-2 control-label')); ?>
                <div class="col-sm-10">
                        <?php echo $form->dropDownList($model, 'user_status', array('3' => "Enabled", '4' => "Disabled"), array('class' => 'form-control')); ?>
