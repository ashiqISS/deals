...
<div class="form">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-10"><?php echo CHtml::activeDropDownList($model, 'country_id', CHtml::listData(MasterCountry::model()->findAll(), 'id', 'country'), array('empty' => '--Select--', 'class' => 'form-control')); ?>
                </div>
        ...
        <div class="form-group">
                ...
                <div class="col-sm-10"><?php echo CHtml::activeDropDownList($model, 'state_id', CHtml::listData(MasterState::model()->findAll(), 'Id', 'state'), array('empty' => '--Select--', 'class' => 'form-control')); ?>
                </div>
