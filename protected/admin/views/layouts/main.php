                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php if (isset(Yii::app()->session['post']['products']) && Yii::app()->session['post']['products'] == 1) { ?>
                            <li class="<?php echo $actionn3 ?> treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="<?php echo $action61 ?>"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/products/Products/admin"><i class="fa fa-circle-o"></i> Manage products</a></li>
                                    <li class="<?php echo $action62 ?>"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/products/Bargain/admin"><i class="fa fa-circle-o"></i> Bargain products</a></li>
                                    <li class="<?php echo $action63 ?>"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/products/UserReviews/admin"><i class="fa fa-circle-o"></i> Manage Reviews</a></li>
                                    <li class="<?php echo $action64 ?>"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/products/coupons/admin"><i class="fa fa-circle-o"></i> Manage Coupons</a></li>
                                </ul>
                            </li>
                        <?php } ?>
                        <?php if (isset(Yii::app()->session['post']['products']) && Yii::app()->session['post']['products'] == 1) { ?>
                        ...
                        <?php if (isset(Yii::app()->session['post']['masters']) && Yii::app()->session['post']['masters'] == 1) { ?>
                            <li class="<?php echo $actionn4 ?> treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="<?php echo $action20 ?> treeview"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/masters/masterTaxClass/admin"><i class="fa fa-circle-o"></i> Tax Classes</a></li>
                                </ul>
                            </li>
                        ...
                        <?php if (isset(Yii::app()->session['post']['masters']) && Yii::app()->session['post']['masters'] == 1) { ?>
                            <li class="<?php echo $actionn9 ?> treeview">
                                <a href="#"><i class="fa fa-mail-reply-all"></i> <span>Pages </span> <i class="fa fa-angle-left pull-right"></i></a>
                                <ul class="treeview-menu">
                                    <li class="<?php echo $action23 ?> treeview"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/Pages/admin"><i class="fa fa-circle-o"></i>Pages</a></li>
                                    <li class="<?php echo $action23 ?> treeview"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/Team/admin"><i class="fa fa-circle-o"></i>Team</a></li>
                        ...
                        <?php if (isset(Yii::app()->session['post']['masters']) && Yii::app()->session['post']['masters'] == 1) { ?>
                            <li class="<?php echo $actionn9 ?> treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li class="<?php echo $action23 ?> treeview"><a href="<?php echo Yii::app()->baseUrl ?>/admin.php/reports/OrderProducts/admin"><i class="fa fa-circle-o"></i>Sales Report</a></li>
